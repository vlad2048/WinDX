...
public static class User32Helpers
{
    ...
    public static bool GetClassInfoEx(IntPtr hInstance, string lpClassName, out WindowClassEx classInfo)
    {
	    if (User32Methods.GetClassInfoEx(hInstance, lpClassName, out var classExBlittable))
        {
            classInfo = new WindowClassEx
            {
                ...
                ClassName = (Marshal.SystemDefaultCharSize == 1
                    ...
                    : Marshal.PtrToStringUni(classExBlittable.ClassName)) ?? throw new ApplicationException("Class shouldn't be null")
